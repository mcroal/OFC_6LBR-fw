...
#define CETIC_6LBR_NVM_DEFAULT_ETH_DFT_ROUTER(a)	uip_create_unspecified(a)//uip_ip6addr(a, 0xbbbb, 0, 0, 0, 0, 0, 0, 0x1)
#define CETIC_6LBR_NVM_DEFAULT_CHANNEL			RF_CHANNEL
