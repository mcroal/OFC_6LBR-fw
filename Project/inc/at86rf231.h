...
//=========================== define ==========================================
#define SUPPORTED_PART_NUMBER                   ( 3 )      //Register 0x1c:PART_NUM
#define RF231_REVA                              ( 2 )      //Register 0x1d:VERSION_NUM
#define SUPPORTED_MANUFACTURER_ID               ( 31 )     //Register 0x1e:MAN_ID_0
...
/*---------------------------------------------------------------------------*/
void at86rf231_rf_set_addr(uint16_t pan);
int rf231_interrupt(void);
/*---------------------------------------------------------------------------*/
