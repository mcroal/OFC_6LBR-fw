...
void System_Setup(void)
{
  ...
  /* Initialize STM3210C-EVAL's USART */
  BSP_USART_Init(115200);
  /* Configure the Ethernet peripheral */
  Ethernet_Configuration();

  /* SystTick configuration: One clock tick is 7.8 ms */
  RCC_GetClocksFreq(&RCC_Clocks);
  SysTick_Config(RCC_Clocks.SYSCLK_Frequency / 128);
...
void Ethernet_Configuration(void)
{
  ...
  ETH_InitStructure.ETH_MulticastFramesFilter = ETH_MulticastFramesFilter_None;     //@mcroal:for ipv6 multicast
...
void GPIO_Configuration(void)
{
  ...
  - ETH_MII_PPS_OUT / ETH_RMII_PPS_OUT: PB5     //@mcroal:Don't use
  - ETH_MII_TXD3: PB8 */
